...
const Auth: FC = () => {
  ...
  return (
    <div className="grid grid-cols-2 h-screen">
      ...
      <div className="flex flex-col justify-center items-center bg-[#000000ea] h-full">
        <div className="-mt-4">
        ...
        {isLoading ? (
          ...
          <>
            ...
            >
              ...
              <button
                type="submit"
                className="text-white mt-8 bg-primary border-2 border-primary py-2 px-10 rounded-3xl cursor-pointer flex items-center justify-center gap-2 hover:bg-[#55307d] transition-all"
              >
